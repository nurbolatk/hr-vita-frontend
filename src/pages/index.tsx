...
export function LandingRoute() {
  return (
    <div>
      <section className="grid grid-cols-2 pr-20">
        ...
        <div className="relative h-full py-6">
          ...
          <div
            className="absolute animate-blob top-6 -left-16 w-64 h-64 bg-purple-300 rounded-full mix-blend-multiply opacity-70"
            style={{
              filter: 'blur(1.5rem)',
            }}
          />
